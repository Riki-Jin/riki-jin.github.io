...
DESeq2 is a tool designed for RNA-seq data, we would perform RLE method as a normalization process. It has high power when there are large differences between two sample groups, but it 
