...
- $\mu$ : mean of the non-ZI part
- $\theta$ : measure of dispersion
- $\pi$ : the probability of the ZI part
...
$$P(X=x) = \begin{cases}
\pi +(1-\pi )(\frac{1}{\theta +1})^{\frac{\mu}{\theta}} & x=0 \\
(1-\pi ) \tbinom{x+\frac{\mu}{\theta}-1}{x} (\frac{1}{\theta +1})^{\frac{\mu}{\theta}} (\frac{\theta}{\theta +1})^{x}  & x>=1
\end{cases}$$
